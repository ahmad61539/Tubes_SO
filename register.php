...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($name) || empty($email) || empty($password)) {
    echo "<div class='alert alert-danger text-center'>Semua field harus diisi!</div>";
  } else {
    $checkEmail = "SELECT * FROM user WHERE email_address = ?";
    ...
    if ($result->num_rows > 0) {
      ...
      $sql = "INSERT INTO user (name, email_address, password) VALUES (?, ?, ?)";
      ...
      if ($stmt->execute()) {
        ...
        echo "<div class='alert alert-danger text-center'>Terjadi kesalahan: " . $stmt->error . "</div>";
      }
    }
              ...
              <?php if ($registrationSuccess): ?>
                <div class='container mt-5'>
                  <div class='alert alert-success text-center' role='alert'>
                    ...
                    <p>Your account has been successfully registered. Please continue to <a href='login.php' class='alert-link'>log in</a> to your account.</p>
                    <hr>
